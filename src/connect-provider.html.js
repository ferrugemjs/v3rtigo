define(["exports","incremental-dom","@ferrugemjs/library/dist/core/component-factory","./connect-provider"], function (exports,_idom,_libfjs_factory,_connect_provider){
	...
	exports.default = (function(super_clazz){
		...
		_clazz_sub_f_dc99976d_d504_4439_87aa_08ec830d5a84_tmp.prototype.$render = function(config_props){if(!config_props.loaded){ _idom.elementOpen("div",""+(config_props.key_id)+"",["class","connect-provider"],"is",(config_props.is),"id",(config_props.key_id));
